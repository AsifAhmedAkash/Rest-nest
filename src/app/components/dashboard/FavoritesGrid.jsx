    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h3 className="text-xl font-semibold text-on-surface">Favorites</h3>
                <p className="text-sm text-on-surface-variant">8 items saved</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {favorites.map((fav) => (
                    <div
                        key={fav.title}
                        className="group bg-white rounded-xl overflow-hidden shadow-[0px_4px_12px_rgba(15,23,42,0.08)] hover:shadow-[0px_12px_32px_rgba(15,23,42,0.12)] hover:-translate-y-1 transition-all duration-300"
                    >
                        {/* Image */}
                        <div className="relative aspect-[4/3] overflow-hidden">
                            ...
                            />
                            <button
                                className="absolute top-3 right-3 bg-white/90 p-2 rounded-full shadow-sm hover:text-error transition-colors"
                        ...
                        <div className="p-4 space-y-2">
                            ...
                            <div className="flex items-center gap-2 text-on-surface-variant">
                                ...
                                <p className="text-sm">{fav.location}</p>
                            </div>
