const properties = [
    {
        ...
        image:
            "https://lh3.googleusercontent.com/aida-public/AB6AXuBAPM_1ORDcnBM-zXSJ7GHkoghIqg6kz97LVULoSx0OmzPK_lf2XGRYiyCUP3debt3354vBQ6EwRlFdHw_HSaN0m3SjCcuSWbjPW5qc4cjNVcVNL5cAeIFSRbKBnVv8V8evutqRbY_ifofdD5w9rtwhjCBZ8WAirjOlQTOcw7Z6P-UNAT0jhfhIRVTMhMSTzIGQz2c1dJfwIZz-fROv0iCsBT6WOUFUTBDEL_b08T0QSYIDMnqOxF--lWi8p9ILb4W0aS9IltgKSY_P",
    },
    {
        ...
        image:
            "https://lh3.googleusercontent.com/aida-public/AB6AXuBfPo4wVeLjtWJfnsiCjxZIM5j2Xrys5nAIxJ4Q4FyuJLdO7jWJQkR_uuR4WJIGnA0ZX6-fXUye04ykQ7X1C3aSPJIvt67KFEZj7aDHp1ZfStuenZVhiRb7PFwZjp_QyxkZmz_fX9liQ3KP_iVbXidkNqN-FQbj5ZXfvOFWr3yzM5w1BaQeR4YG1p5t7bJo7r-dE2oQhd0lDPIG97DByXNhdlvD1izLRq-ASTuJcrJW-MOhdIcYZZAvzW4MH9pmofI1q5F28_yRKFeO",
    },
    {
                        ...
                        <thead>
                            <tr className="bg-surface-container text-on-surface-variant">
                                {["Property", "Price", "Type", "Status", "Actions"].map((col) => (
                                    <th key={col} className="px-6 py-4 text-sm font-semibold">
                                        {col}
                                    </th>
                                ))}
                            </tr>
                        ...
                        <tbody className="divide-y divide-outline-variant/20">
                            {properties.map((p) => (
                                ...
                                >
                                    ...
                                    {/* Status */}
                                    <td className="px-6 py-4">
                                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${p.statusStyle}`}>
                                            {p.status}
                                        </span>
                                    </td>
                                    {/* Actions */}
