const locations = [
    {
        name: "London",
        image:
            "https://lh3.googleusercontent.com/aida-public/AB6AXuBglhSyX9eL3H-U2917WUVzkDd1Z5wI-U33wOvYFT58-238roGkdBZ-m8QwKWWfb67LmyCVLMq0fO-5Xv41CMWPDFovZRC_nLgLvj_c3q1TaBMQF8fzm7pL4ocL-6tFYdoUsbLe-s_uTjJYBKP_lWk4IJ7sNRg6EbLQ4PGBt1Teb8nlgJ9gWVpRFWv8fsmoTHFKdKKTBSErVFJcfSsRAwCOtPqjNFfiexTLxwRmMDiGi_VPd6CPVrnVrW3GCQAPsfgXtu16W77I46WQ",
    },
    {
        name: "New York",
        image:
        ...
        <section className="py-20 px-4 md:px-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                {locations.map((loc) => (
                    ...
                    >
                        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-surface-container-high group-hover:border-secondary transition-all">
                            <div
